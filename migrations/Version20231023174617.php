 ...
 */
final class Version20231023174617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE room (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, address VARCHAR(255) NOT NULL, capacity INT NOT NULL, day_price DOUBLE PRECISION NOT NULL, is_rentable TINYINT(1) NOT NULL, picture VARCHAR(255) DEFAULT NULL, FULLTEXT INDEX Room (name, address), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
